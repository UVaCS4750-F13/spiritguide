...
<?php echo $this->Form->create('Take'); ?>
	<fieldset>
		<legend><?php echo __('Edit Take'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Take.cocktail_id, ingredient_id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Take.cocktail_id, ingredient_id'))); ?></li>
